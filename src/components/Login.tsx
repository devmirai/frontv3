...
import { Form, Input, Button, Card, Typography, Alert, Tabs, Select, Row, Col, Divider } from "antd"
import {
  UserOutlined,
  LockOutlined,
  MailOutlined,
...
const Login: React.FC = () => {
  ...
  const handleLogin = async (values: LoginFormData) => {
    ...
    try {
      ...
      const success = await login(values.email, values.password, values.userType)
                            ...
                            children: (
                              ...
                              >
                                ...
                                >
                                  ...
                                  <Form.Item
                                    name="userType"
                                    label={<span className="login-form-label">Account Type</span>}
                                    rules={[{ required: true, message: "Please select account type" }]}
                                    className="login-form-item"
                                  >
                                    <Select placeholder="Select your account type" className="login-select">
                                      <Option value="user">
                                  ...
                                  <Row gutter={16}>
                                    ...
                                    <Col span={12}>
                                      <Form.Item
                                        ...
                                        className="login-form-item"
                                      >
                                        <Select placeholder="Select account type" className="login-select">
                                          <Option value="user">
                                            <UserOutlined /> Candidate
                                          </Option>
                                          <Option value="company">
